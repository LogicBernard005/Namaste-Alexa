...
# Here we will make use of Flask to make a web application out 
# of our alexa_model

# Flask is a application to convert our python codes to restful APIs
# so that we can expose those APIs for the UI to consume
